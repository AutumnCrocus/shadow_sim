...
def load_json(target_game_name,file_name):
    ...
    TARGET = target_game_name +"_"+file_name+ ".txt"
...
if __name__ == '__main__':
    ...
    names, texts = load_json(TARGET_GAME_NAME,"{}_{}".format(args.vector_size,args.window_size))
    
    target_file_name = "{}_{}_{}".format(TARGET_GAME_NAME,
                                                         args.vector_size,args.window_size)
    if os.path.isfile(target_file_name + ".model") is True:
        model = doc2vec.Doc2Vec.load(TARGET_GAME_NAME + ".model")
    else:
        model = generate_doc2vec_model(target_file_name,size=args.vector_size,window=args.window_size)
