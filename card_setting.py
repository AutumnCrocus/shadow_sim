...
def tsv_to_card_list(tsv_name):
    ...
    with open("Card_List_TSV/"+tsv_name) as f:
        ...
        for row in reader:
            ...
            card_name=row[-1]
            #print("name:{}".format(card_name))
            #print("class:{}".format(row))
            ...
            if card_category=="Creature":
                ...
                card_list[card_id].extend([card_category,ability_id])
            elif card_category=="Amulet":
                has_count=bool(int(row[3]))
                count=None
                ability_id=int(row[5])
                if has_count:
                    count=int(row[4])
                card_list[card_id].extend([card_category,has_count,count,ability_id])
                    
            else:
                assert False,"{}".format(card_category)
            if card_class==LeaderClass["RUNE"].value:
                spell_boost=list(row[-4].split(","))
...
"""
creature_list={1:[1,1,2,[],[0,-1],"Goblin"],2:[2,2,2,[],[0,-1],"Fighter"],3:[3,2,3,[],[0,-1],"Ax Fighter"],\
    4:[4,3,4,[],[0,-1],"Golyat"],5:[5,4,5,[],[0,-1],"Feena"],6:[3,2,2,[1],[2,0],"Novice Trooper"],7:[2,2,1,[2],[5,-1],"Spector"],8:[8,5,4,[1],[0,-1],"Gilgamesh"]\
    ,9:[3,2,3,[],[0,-1],"Healing Angel"],10:[3,3,3,[],[2,0],"War Dog"],11:[3,1,2,[],[0,-1],"Purehearted Singer"],\
    12:[2,2,1,[],[4,-1],"Fire Lizard"],13:[7,4,4,[],[4,-1],"Dread Dragon"],14:[3,1,4,[3],[0,-1],"Shield Angel"],15:[10,5,10,[1,2,3],[0,-1],"Zeus"],\
    16:[10,13,13,[],[0,-1],"Bahamut"],\

    17:[1,1,1,[1],[2,0],"Quickblader"],18:[3,3,2,[4],[2,0],"Blitz Lancer"],19:[2,0,2,[3],[0,-1],"Bellringer Angel"],\
    20:[2,2,2,[3],[2,0],"Veteran Lancer"],21:[6,4,6,[],[2,1],"Sage Commander"],22:[6,3,4,[],[2,1],"Sea Queen Otohime"],\
    23:[5,2,6,[3],[2,1],"Aurelia, Regal Saber"],24:[4,2,2,[],[2,0],"Courageous Knight"],25:[2,1,1,[],[2,0],"Oathless Knight"],\
    26:[4,3,4,[],[2,0],"Floral Fencer"],27:[8,6,7,[],[0,-1],"Lucifer"],28:[2,2,2,[],[0,-1],"Unicorn Dancer Unica"],\

    29:[4,3,4,[],[4,-1],"Dragon Warrior"],30:[3,2,2,[5],[4,-1],"Trinity Dragon"],31:[10,7,9,[1],[4,-1],"Genesis Dragon"],\
    32:[3,2,2,[],[4,-1],"Aiela, Dragon Knight"],33:[10,7,7,[],[3,[True,True],-1],"Flame Destroyer"],\

    34:[4,1,1,[],[3,[True,False],-1],"Rune Blade Summoner"],35:[9,4,4,[],[3,[True,True],-1],"Chimera"],\
    36:[9,3,5,[1],[3,[True,True],-1],"Zealot of Truth"],37:[1,1,1,[],[6,-1],"Ambling Wraith"],\
    38:[1,1,2,[],[6,-1],"Cursebrand Vampire"],39:[2,2,1,[1],[6,-1],"Blood Wolf"],\
    40:[4,4,3,[],[6,-1],"Dark General"],41:[4,3,4,[],[6,-1],"Wardrobe Raider"],\
    42:[2,1,4,[3],[6,-1],"Spiderweb Imp"],43:[9,5,5,[],[6,-1],"Temptress Vampire"],\
    44:[4,2,5,[],[6,-1],"Righteous Devil"],\
    45:[2,1,1,[],[2,0],"Maid Leader"],46:[6,4,3,[7],[2,0],"Tsubaki"],47:[3,2,2,[4],[2,0],"Young Ogrehunter Momo"],\
    48:[2,1,3,[],[2,1],"Princess Vanguard"],\

    49:[2,1,2,[],[5,-1],"Lurching Corpse"],50:[2,1,2,[],[5,-1],"Demon Eater"],51:[1,1,1,[],[5,-1],"SkeltonFighter"],\
    52:[2,1,2,[],[5,-1],"Andrealphus"],53:[2,2,2,[],[5,-1],"Belenus"],54:[2,1,3,[8],[5,-1],"Lady Grey, Deathweaver"],\
    55:[3,3,2,[],[5,-1],"Rabbit Necromancer"],56:[8,5,5,[],[5,-1],"Mordecai the Duelist"],57:[7,4,5,[3],[5,-1],"Underworld Watchman Khawy"],\
    58:[7,5,6,[],[5,-1],"Demonlord Eachtar"],59:[1,1,2,[],[5,-1],"Skull Beast"],\

    60:[2,1,3,[],[6,-1],"Yurius, Levin Duke"],\

    61:[2,2,1,[],[7,-1],"Rabbit Healer"],62:[5,2,4,[],[7,-1],"Radiance Angel"],63:[2,2,2,[],[7,-1],"Holy Bowman Kel"],\
    64:[4,4,3,[],[7,-1],"Kel, Holy Marksman"],65:[4,3,4,[3],[7,-1],"Elana, Purest Prayer"],\

    66:[2,2,2,[],[3,[False],-1],"Dwarf Alchemist"],67:[2,2,2,[],[3,[False],-1],"Magic Illusionist"],68:[3,3,2,[],[3,[False],-1],"Mage of Nightfall"],\
    69:[4,4,3,[],[3,[False],-1],"Halo Golem"],70:[6,4,4,[],[3,[False],-1],"Master Mage Levi"],\
    71:[3,3,2,[],[3,[False],-1],"Magisa, Ruinfist Witch"],\

    72:[1,1,1,[],[1,-1],"Water Fairy"],73:[1,1,1,[],[1,-1],"Elf Child May"],74:[2,1,1,[],[1,-1],"Fairy Whisperer"],\
    75:[2,1,1,[1],[1,-1],"Rhinoceroach"],76:[3,2,3,[3],[1,-1],"Ancient Elf"],77:[4,3,4,[],[1,-1],"Elven Princess Mage"],\
    
    79:[2,2,2,[],[2,0],"Fervid Soldier"],\
    
    80:[2,2,1,[],[1,-1],"Elf Metallurgist"],81:[5,1,1,[],[1,-1],"Crystalia Tia"],\
    
    82:[3,2,2,[2],[4,-1],"Dragoon Scyther"],83:[2,2,2,[],[4,-1],"Wind Reader Zell"],\
    84:[5,4,5,[],[4,-1],"Sibyl of the Waterwyrm"],85:[8,8,4,[],[4,-1],"Ouroboros"],86:[4,2,5,[3],[4,-1],"Rahab"],\
    
    87:[3,2,3,[3],[0,-1],"Grimnir, War Cyclone"],88:[7,4,4,[],[0,-1],"Sahaquiel"],89:[9,8,8,[],[0,-1],"Israfil"],\
    
    90:[5,5,5,[],[3,[False],-1],"Orichalcum Golem"],\

    -1:[3,2,3,[3],[2,0],"Pirate"],-2:[3,3,2,[1],[2,0],"Viking"],-3:[1,1,2,[],[2,0],"Otohime's Bodyguard"],\
    -4:[1,1,1,[],[2,0],"Knight"],-5:[2,2,2,[],[2,0],"Steelclad Knight"],-6:[6,5,5,[1],[4,-1],"Windblast Dragon"],\
    -7:[3,2,1,[1],[7,-1],"Holy Falcon"],-8:[4,4,4,[],[7,-1],"Holyflame Tiger"],-9:[5,3,4,[1],[7,-1],"Regal Falcon"],\
    -10:[6,5,4,[3,6],[7,-1],"Barong"],-11:[2,2,2,[],[3,[False],-1],"Clay Golem"],\
    -12:[1,1,1,[1],[5,-1],"Ghost"],-13:[2,2,2,[],[5,-1],"Zombie"],\
    -14:[6,6,6,[],[7,-1],"Holywing Dragon"],\
    -15:[1,0,2,[3],[3,[False],-1],"Scrap Golem"],-16:[1,1,1,[],[1,-1],"Fairy"],-17:[4,4,4,[],[1,-1],"Crystalia Eve"]}
"""
creature_name_to_id={}
...
creature_fanfare_ability={9:1,10:2,11:3,12:4,13:5,16:6,21:7,22:8,23:9,24:10,25:11,34:16,35:5,37:17,38:18,\
    ...
    73:33,74:51,75:52,76:53,80:55,81:56,82:57,84:59,85:61,87:64,88:65,89:67,3:68}
...
creature_evo_effect={26:12,29:14,41:21,52:32,54:34,64:41,65:42,66:44,77:54,83:58}
creature_has_evo_effect_target={29:1,41:1,83:2}
...
#9:相手の場の全てのカード
creature_enhance_list={3:[6],10:[6],87:[10]}
...
class Card:
    ...
    def get_current_toughness(self):
        assert False
    def can_attack_to_creature(self):
        assert False
...
class Creature(Card):
    def __init__(self,card_id):
        ...
        self.evolved=False
        self.can_creature_attack=KeywordAbility.RUSH.value in creature_list[card_id][3]#突進を持つか
        self.can_not_be_attacked=KeywordAbility.CANT_BE_ATTACKED.value in creature_list[card_id][3]#攻撃されないを持つか
        self.can_not_be_targeted=KeywordAbility.CANT_BE_TARGETED.value in creature_list[card_id][3]#能力の対象にならないを持つか
    ...
    def __str__(self):
        ...
        if self.is_in_field==True:
            if self.can_attack_to_player():
                text+="\033[36m"
            elif self.can_attack_to_creature():
                text+="\033[33m"
        if self.is_in_field==True:
